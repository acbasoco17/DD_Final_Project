            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    <ul class="navbar-nav me-auto mb-2 mb-md-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active"aria-current="page" href="artists.php">Artists</a>
                        </li>
                        <li class="nav-item">
        ...
        <div class="album py-5 bg-body-tertiary">
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    $query = "SELECT * FROM `Artist` WHERE `artist` LIKE '%$keywords%'";
                    $search_result = mysqli_query($con, $query) or die(mysqli_error($con));
                    while ($row = mysqli_fetch_array($search_result)) {
                    ?>
                        <div class="col">
                            <div class="card shadow-sm">
                                <img class="bd-placeholder-img card-img-top" width="100%" height="300" src="<?php echo $row['poster'] ?>">

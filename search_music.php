...
$_SESSION['destination'] = "search_music.php";
?>
            ...
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    ...
                    if ($_SERVER["REQUEST_METHOD"] == "POST") {
                        ...
                        $query = "SELECT * FROM `Music_Library` WHERE `title` LIKE '%$keywords%'";
                    } else {
                    ...
                    ?>
                        <div class="col">
                            ...
                            <a href="song.php?id=<?php echo $id ?>">
                                <img class="bd-placeholder-img card-img-top" width="100%" height="300" src="<?php echo $row['cover_image'] ?>">
                    </a>
                                <div class="card-body">

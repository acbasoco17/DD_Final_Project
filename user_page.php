...
$_SESSION['destination'] = 'user_page.php';
?>
                ...
                <div class="d-flex justify-content-evenly">
                    ...
                    <div class="flex-lg-fill mt-5">
                        ...
                        ?>
                            ...
                            <h3>Email: <?php echo $row['0'] ?></h3>
                            <h3>Account Created: <?php echo $row['3'] ?></h3>
                    </div>
                </div>
            </div>
        </section>
        ...
        <div class="album py-5 bg-body-tertiary">
            ...
            <div class="container">
                ...
                <div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 g-3">
                    <?php
                    $user = $_GET['user'];
                    $query = "SELECT * FROM `Friends` WHERE `username_user`='$user'";
                    $search_result = mysqli_query($con, $query) or die(mysqli_error($con));
                    while ($row = mysqli_fetch_array($search_result)) {
                    ?>
                        <div class="col">
                            ...
                            <a href="user_page.php?user=<?php echo $row['username_friend'] ?>">
                                ...
                                <div class="card-body">
                                    ...
                                    <?php
                                        ...
                                        $username_friend = $row['username_friend'];
                                        ...
                                        ?>
                                            <a href="add_friend.php?friend=<?php echo $row['username_friend'] ?>&name=<?php echo $row['friend_name'] ?>" type="button" class="btn btn-sm btn-outline-secondary">Add</a>
                                        <?php
                                        } else { ?>
                                            <a href="remove_friend.php?friend=<?php echo $row['username_friend'] ?>" type="button" class="btn btn-sm btn-success"> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-check" viewBox="0 0 16 16">
